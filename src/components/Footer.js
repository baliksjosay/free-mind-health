	...
	return (
      ...
      <Col xl="3" lg="3" md="3" sm="6" xs="6" className="sociallinks" >
        <p>< h6>Social Links</ h6></p>
           <hr />
        <p><a href="https://www.facebook.com/FreeMindTherapyuganda/" className="facebooktwitter"><FaFacebookSquare style={{color:"dodgerblue"}}/>/@FreeMindTherapyUganda</a></p>
        <p><a href="#" className="mail"><FaEnvelope />info@freemindtherapy.com </a></p>
        <p><a href="https://twitter.com/FreeMindtherapy?s=08" className="facebooktwitter"><FaTwitterSquare style={{color:"dodgerblue"}}/>@FreeMindtherapy</a></p>
